...
![post_thumbnail](/assets/images/ALS/StrideBlend_1.png)
...
![post_thumbnail](/assets/images/ALS/StrideBlend_2.png)

* 이를 테면 캐릭터의 스케일을 10배 키웠고, 위 그래프와 같이 StrideBlend_N_Run 에셋의 Y축 1에 대응하는 X축 값이 기존 600이라면,

![post_thumbnail](/assets/images/ALS/StrideBlend_3.png)
