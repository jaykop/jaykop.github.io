---
title: "[DevNote] ALS 캐릭터 스케일링에 따른 PlayRate 조절 Troubleshooting"
classes: wide
categories: 
  - project
  - project_aa
...
![post_thumbnail](/assets/images/ALS/ALS_StrideBlend_1.png)
...
![post_thumbnail](/assets/images/ALS/ALS_StrideBlend_2.png)

* 이를 테면 캐릭터의 스케일을 10배 키웠고, 위 그래프와 같이 StrideBlend_N_Run 에셋의 Y축 1에 대응하는 X축 값이 기존 600이라면,

![post_thumbnail](/assets/images/ALS/ALS_StrideBlend_3.png)
