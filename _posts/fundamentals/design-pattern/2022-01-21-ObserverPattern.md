...
## 관찰자 패턴 (감시자 패턴)
### 관찰자 패턴의 사례
* [MVC 패턴](https://jaykop.github.io/fundamentals/design-pattern/MVC/#mvc-%ED%8C%A8%ED%84%B4)
* C#의 event
* java의 라이브러리
...
* 관찰자 패턴을 사용하는 시스템이 Queuing이나 동적할당을 하기 때문에 실제로 느릴 수 있다
  ...
  * 성능에 민감하지 않다면 [동적 디스패치](https://jaykop.github.io/fundamentals/design-pattern/ObserverPattern/#%EB%8F%99%EC%A0%81-%ED%95%A0%EB%8B%B9)를 사용해도 된다
...
![image](/assets/images/ObserverPattern/01.png)  
...
![image](/assets/images/ObserverPattern/02.png)  
