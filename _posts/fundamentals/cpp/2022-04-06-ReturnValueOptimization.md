...
### 일반적인 함수의 반환 방식
![post_thumbnail](/assets/images/ReturnValueOptimization/01.png)
* 반환할 값만큼의 스택 메모리가 있고, 그 값을 연산할 함수 실행을 위한 메모리가 할당된다

![post_thumbnail](/assets/images/ReturnValueOptimization/02.png)
...
![post_thumbnail](/assets/images/ReturnValueOptimization/03.png)
...
public:
  ...
  // case 3
  // **이런 식에서는 이름 없는 반환 값에 대한 RVO가 작동한다
  A case3()
  {
    return A(a + 10);
  }
