...
![post_thumbnail](/assets/images/UnrealNavigationTheory/01.png)
...
![post_thumbnail](/assets/images/UnrealNavigationTheory/02.png)

* NavMeshBoundVolume을 레벨에 배치한다

2. **Define the mesh size**

![post_thumbnail](/assets/images/UnrealNavigationTheory/03.png)
...
![post_thumbnail](/assets/images/UnrealNavigationTheory/04.png)

* NavMesh를 배치하면 자동으로 빌드 된다.
* P키를 눌러 에디터 상태에서 어느 부분에 NavMesh가 세팅되었는지 볼 수 있다.

![post_thumbnail](/assets/images/UnrealNavigationTheory/05.png)
...
![post_thumbnail](/assets/images/UnrealNavigationTheory/06.png)
...
![post_thumbnail](/assets/images/UnrealNavigationTheory/07.png)
...
![post_thumbnail](/assets/images/UnrealNavigationTheory/08.png)
