...
![post_thumbnail](/assets/images/InGameCamera/01.png)
...
<figure class="half">
    <a href="/assets/images/InGameCamera/02.png"><img src="/assets/images/InGameCamera/02.png"></a>
    <a href="/assets/images/InGameCamera/03.png"><img src="/assets/images/InGameCamera/03.png"></a>
</figure>
...
![post_thumbnail](/assets/images/InGameCamera/04.png)

* 상기한 카메라 구조체는 하나의 데이터 에셋으로서 존재한다

![post_thumbnail](/assets/images/InGameCamera/05.png)

* 그리고 이런 하나의 카메라 구도 에셋을 여러 개 모아 상황별 카메라 데이터 에셋을 만든다

![post_thumbnail](/assets/images/InGameCamera/06.png)
