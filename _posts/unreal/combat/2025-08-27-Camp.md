...
{
  ACheckpointActor* DefaultCamp = nullptr;
  ...
  if (IsValid(StartingCamp) == false)
  {
    ...
    UGameplayStatics::GetAllActorsOfClass(this, ACheckpointActor::StaticClass(), AllCampActors);

    for (AActor* Actor : AllCampActors)
    {
      if (ACheckpointActor* CampActor = Cast<ACheckpointActor>(Actor))
      {
...
> [!NOTE]  
> ![post_thumbnail](/assets/images/Camp/01.png)  
>  
...
![post_thumbnail](/assets/images/Camp/02.png)  
...
```c++
bool ACheckpointActor::TryTeleport(APlayerController* PlayerController)
{
