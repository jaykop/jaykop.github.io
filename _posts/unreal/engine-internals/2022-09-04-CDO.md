---
title: "[Unreal] Class Default Object (CDO)"
classes: wide
categories:
  - unreal
  - engine-internals
...
### CDO를 왜 사용하는가?
* [프로토타입 패턴](https://jaykop.github.io/fundamentals/design-pattern/PrototypePattern/)의 일환으로 생각하면 될 것 같다
  * UPROPERTY로 마킹된 변수는 에디터에서 기본값을 변경할 수 있으며, 
인스턴스별 Override 값을 저장할 수 있다 
