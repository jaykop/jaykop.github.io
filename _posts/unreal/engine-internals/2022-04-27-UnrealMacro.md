...
## 언리얼에 매크로를 사용하는 이유
* 언리얼 C++ 코드는 [Unreal Header Tool](https://www.unrealengine.com/ko/blog/unreal-property-system-reflection), UHT Preprocessor라 불리는 커스텀 [RTTI](https://jaykop.github.io/fundamentals/cpp/rtti/)를 사용한다
