...
![post_thumbnail](/assets/images/dualsense/01.png)
...
![post_thumbnail](/assets/images/dualsense/02.png)
...
* DualSense를 지원하는 다른 게임을 실행한 뒤 빌드를 실행하면 이상한 타이밍에서 진동이 온다는 리포트가 있었다
