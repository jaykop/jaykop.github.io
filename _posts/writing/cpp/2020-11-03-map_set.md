...
## 2-3 Tree
![post_thumbnail](/assets/images/map_set/01.png)
...
### 삽입 예시 1
![post_thumbnail](/assets/images/map_set/02.png)
![post_thumbnail](/assets/images/map_set/03.png)
* 새로운 원소 D를 삽입

### 삽입 예시 2
![post_thumbnail](/assets/images/map_set/04.png)
* 새로운 원소 O을 삽입
* 4-node를 분리하고 N이 위로 올라감
![post_thumbnail](/assets/images/map_set/05.png)
* 한 레벨 위로 올라간 N은 L.P와 동일 계층이 됨
* N은 다시 한 레벨 더 위로 올라감
![post_thumbnail](/assets/images/map_set/06.png)
...
### 삽입 예시
![post_thumbnail](/assets/images/map_set/07.gif)
...
![post_thumbnail](/assets/images/map_set/08.png)
