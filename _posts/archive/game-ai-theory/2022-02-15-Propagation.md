...
![image](/assets/images/Propagation/04.png)  
* 이때 최종 수치 산출하는 방법은
  1. multiplied
  2. mean
  3. geometric mean
...
## Propagation
![image](/assets/images/Propagation/05.png)  
...
### Growing Factor 
![image](/assets/images/Propagation/06.png)  
* influence value를 업데이트 하면서 기존 값과 새 값 중 어느 값에 더 편중할지

### How to propagate?
![image](/assets/images/Propagation/07.png)  
...
![image](/assets/images/Propagation/08.png)  
* 보간 공식에 따라 값 연산
* 해당 값을 TempLayer에 저장

![image](/assets/images/Propagation/09.png)  
* 최종 연산한 값들이 저장된 TempLayer의 값을 Original Layer에 복사

### Why using double bufferubg?
![image](/assets/images/Propagation/10.png)  
