...
## HTTP 동작
![post_thumbnail](/assets/images/HTTP/01.png)
* 클라이언트가 브라우저를 통해 서비스를 요청하면 서버가 응답
	* 요청 : client -> server
	* 응답 : server -> client

## HTTP 특징
![post_thumbnail](/assets/images/HTTP/02.png)
...
## 공개키와 개인키
![post_thumbnail](/assets/images/HTTP/03.png)
* HTTPS의 데이터 암호화 방식
* 서로 하나의 쌍을 이룸
	* 공개키: 모두에게 공개가능한 키
...
![post_thumbnail](/assets/images/HTTP/04.png)
