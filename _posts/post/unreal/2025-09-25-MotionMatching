...
![post_thumbnail](/assets/images/MotionMatching/MotionMatching_1.png)

**!. 캐릭터 상태 전달**

![post_thumbnail](/assets/images/MotionMatching/MotionMatching_2.png)
...
![post_thumbnail](/assets/images/MotionMatching/MotionMatching_3.png)

* ABP에서 전달된 정보를 기준으로 적절한 PSD를 선택한다

**3. 조건에 맞는 동작 찾기**

![post_thumbnail](/assets/images/MotionMatching/MotionMatching_4.png)
...
![post_thumbnail](/assets/images/MotionMatching/MotionMatching_5.png)
